...
int main()
{
	...
	BMI Student_1(name, height, weight); //using overload constructor

	cout << endl << 
		"Patient name: " << Student_1.getName() << endl << 
		"Height: " << Student_1.getHeight() << endl << 
		"Weight: " << Student_1.getWeight() 
		<< endl;
	...
	BMI Student_2;  //using mutator methods
	...
	cout << endl <<
		...
		"Weight: " << Student_2.getWeight()
		<< endl <<
		"BMI: " << Student_2.calculateBMI() << endl;

	cout << endl << Student_1.getName() << endl;
